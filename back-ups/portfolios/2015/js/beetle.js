...
jQuery(document).ready(function ($) {
    ...
    var win = $(window),
        ...
        moreBtnIcon = '<div class="more"><a href="#main"><i class="fa fa-chevron-circle-down"></i></a></div>';
        ...
        lightboxContainer.each(function () {
            ...
            var activityIndicatorOn = function () {
                ...
                closeButtonOn = function (instance) {
                    $('<a href="#" id="imagelightbox-close"><i class="fa fa-close"></i></a>').appendTo('body').on('click', function () {
                        $(this).remove();
                ...
                captionOn = function () {
                    ...
                    if (description.length > 0)
                        ...
                        // $('#imagelightbox-caption').each(function(evt) {
